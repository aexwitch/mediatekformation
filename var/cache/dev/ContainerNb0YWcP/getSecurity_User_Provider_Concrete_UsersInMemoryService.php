...
class getSecurity_User_Provider_Concrete_UsersInMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.users_in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['Admin123' => ['password' => '$2y$10$J24JClufhmuer1E0QKn06eSULmDP0AdMNl8B5KktSXf0OCP.RuQAm', 'roles' => ['ROLE_ADMIN']]]);
    }
}
