...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 27 avr. 2026 à 09:36
...
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`, `description`) VALUES
('DoctrineMigrations\\Version20240513134621', '2024-05-13 13:47:49', 1145, NULL);
...
(1, 1, '2021-01-04 17:00:12', 'Formation vidéo', 'la vidéo est indisponible', 'https://www.youtube.'),
...
INSERT INTO `formation_categorie` (`formation_id`, `categorie_id`, `description`) VALUES
(1, 1, NULL),
(2, 1, NULL),
(3, 1, NULL),
(4, 1, NULL),
